...
void CImage::SetPixels(void *val_ptr)
{
    ...
    unsigned char *vc = (unsigned char *) val_ptr;
    ...
    {
        unsigned char *rp = (unsigned char *) PixelAddress(0, y, 0);
        if (all_same)
...
template <> unsigned char CImageOf<unsigned char>::MinVal(void)     { return 0; }
template <> unsigned char CImageOf<unsigned char>::MaxVal(void)     { return 255; }
