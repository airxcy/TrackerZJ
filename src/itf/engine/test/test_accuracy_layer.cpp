...
#include "itf/engine/test/test_caffe_main.hpp"
...
class AccuracyLayerTest : public ::testing::Test {
 protected:
  ...
  virtual void FillBottoms() {
    ...
    shared_ptr<Engine::RNG> rng(new Engine::RNG(prefetch_rng_seed));
    itf::rng_t* prefetch_rng =
          static_cast<itf::rng_t*>(rng->generator());
