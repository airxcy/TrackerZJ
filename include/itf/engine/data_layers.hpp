...
class ImageDataLayer : public BasePrefetchingDataLayer<Dtype> {
 ...
 protected:
  shared_ptr<Engine::RNG> prefetch_rng_;
...
class MemoryDataLayer : public BaseDataLayer<Dtype> {
 public:
  ...
  void AddMatVectorDensity(const vector<cv::Mat>& mat_vector);
...
template <typename Dtype>
class MemoryDataLayerNew : public BaseDataLayer<Dtype> {
    public:
      explicit MemoryDataLayerNew(const LayerParameter& param): BaseDataLayer<Dtype>(param), has_new_data_(false) {}
      virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom, vector<Blob<Dtype>*>* top);
      
      virtual inline const char* type() const { return "MemoryDataNEW"; }
      virtual inline int ExactNumBottomBlobs() const { return 0; }
      virtual inline int ExactNumTopBlobs() const { return 3; }

    //virtual void AddDatumVector(const vector<Datum>& datum_vector);

      virtual void AddBlobZcVector(const vector<BlobZc>& blobzc_vector);
      virtual void AddDatum(const Datum& datum, int index);
    ...
    protected:
        ...
        Blob<Dtype> added_data_;
        Blob<Dtype> added_label_;
        Blob<Dtype> added_num_;

        BlobZc added_blobzc_;
        bool has_new_data_;
